# Nhân vật: lớp, chủng tộc, chỉ số, vũ khí

Hệ nhân vật theo D&D 5e (Player's Handbook 2014), chơi theo kiểu hành động của game. Có từ 25/09/2026 (góp ý người chơi). Code: `Data/ClassDef.cs`, `Data/RaceDef.cs`, `Data/WeaponKinds.cs`, `Progression/PlayerStats.cs`, `Player/HeroLook.cs`, `Player/HeroArt.cs`, `Items/Forge.cs`. Dữ liệu: `Editor/HeroDataFactory.cs`, kỹ năng: `Editor/ClassAbilityFactory.cs`.
...
Bên phải là nhân vật xem trước: đi, đứng, đánh, niệm phép, xoay 4 hướng. **Lớp và chủng tộc chọn một lần**; ngoại hình và vũ khí đổi lại được ở bảng Nhân Vật (C → *Ngoại hình*). Nhân vật cũ được trả lại toàn bộ điểm đã cộng khi chọn lớp. Online máy chủ kiểm tra lựa chọn (`CharacterChoice`), lưu nó cùng nhân vật và gửi cho mọi người chơi khác để vẽ đúng.
...
- **Kháng (saving throw)**: lớp kháng Thông Thái thì Choáng, Trói, Nguyền ngắn hơn 20%; kháng Thể Chất thì Độc ngắn hơn 25%. Trên bảng Nhân Vật đánh dấu ★.
...
Thợ Rèn ở làng Lá Xanh (cạnh lò lửa, phía đông nam). Bấm F cạnh ông để mở Lò Rèn:

- **Đổi vũ khí** trong số vũ khí của lớp, miễn phí; cấp rèn giữ nguyên.
- **Rèn** +1 tới +10, mỗi cấp +8% công vũ khí, từ +7 vũ khí phát sáng. Vật liệu theo đúng con đường qua các vùng:
...
Online máy chủ kiểm tra người chơi đứng cạnh Thợ Rèn và đủ vàng, vật liệu (`ActKind.Forge`).
