...
- **Hit-stop 3 mức:** 35 ms đòn thường · 70 ms chí mạng và đòn cuối combo · 120 ms vỡ Trấn Áp và đòn kết liễu boss hoặc Tinh Anh (hạ quái thường: ít nhất 35 ms). Số của Lướt Hoàn Hảo và hit-stop nằm trong `Assets/Data/Combat.asset`.
